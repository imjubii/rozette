...
?>
        <meta http-equiv="refresh" content="0; url = https://rozette.xyz/adminDashboard.php">
    <?php
    } else if ($rowForModerator == 1) {
        $_SESSION['userName'] = $userName;
    ?>
        <meta http-equiv="refresh" content="0; url = https://rozette.xyz/moderatorDashboard.php">
<?php
    } else {
