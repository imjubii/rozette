...
<body>
    ...
    <div class="div">
        <form action="./manageAccount/manageAccount.php" method="post" class="form">
            <button class="button">Manage Account</button>
        </form>

        <form action="./parcel/parcelDashboard.php" method="post" class="form">
            <button class="button">Parcel</button>
        </form>
